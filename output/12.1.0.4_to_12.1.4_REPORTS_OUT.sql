...
ALTER TABLE SmsPerformanceLinkClick ADD active Number DEFAULT 1 NOT NULL;
	...
	declare begin execute immediate 'CREATE TABLE PushPerformanceSent (
...
/                
	...
	declare begin execute immediate 'CREATE TABLE PushPerformanceDelivery (
      	id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
	  	journeyId NUMBER(20,0),
	  	pointId Number(20),
	  	pointName VARCHAR2(250 CHAR),
...
/
	...
	declare begin execute immediate 'CREATE TABLE PushPerformanceOpen (
      	id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
	  	journeyId NUMBER(20,0),
	  	pointId Number(20),
	  	pointName VARCHAR2(250 CHAR),
